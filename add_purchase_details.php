...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `purchase_details` (item_code,quantity,price,amount,purchase_master_id)
    values($itemcode,$quantity,$price,$amount,$purchaseid)";
    $result = mysqli_query($connection, $sql);
    if ($result) {
        // echo "Data Inserted Successfully";
    ...
    <div class="container">
        ...
        <form method="POST" autocomplete="off" class="was-validate" novalidate>
            ...
            <div class="form-group">
                ...
                <datalist name="itemcode" id="datalistitemname"> 
            ...
            <!-- <div class="form-group">
                ...
                <select name="price" id="price" class="form-control" required placeholder="Price">
                    <option value="">Price</option>
                </select>
            </div>  -->
            <!-- price copy ends here -->
            <div class="form-group">
    ...
    $(document).ready(function(){
        ...
        $('#brandid').on('change',function(){
            ...
            $.ajax({
                method:"POST",
                url: "response.php",
                data :{bi:brandId, ci: itemCode},
                datatype:'html',
                success:function(data){
                    $('#price').closest().find('#price').val(data);
                }
            });
        });
    });
