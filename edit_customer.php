...
use LDAP\Result;
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "UPDATE `sale_mstr` SET customer_name = '$name', number = $mobile, customer_address ='$caddress', invoice_no = $invoiceno, totalamount = $totalAmount, datetime = CURRENT_TIMESTAMP() WHERE id = $editid";
        ...
        if($connection->query($sql)){
            ...
            for($i = 0; $i<count($_POST["pname"]);$i++){
                ...
                $rows[] = "('{$pname}','{$brand}','{$qty}','{$price}','{$total}','{$editid}')";
            }
            $sql2.=implode(",",$rows);
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>
                                <input type="text" required name="pname[]" class="form-control" list="datalistitemname" value="<?php echo $row2["item_code"]?>">
                            ...
                            <td>
                                <input type="text" required name="brand[]" class="form-control brand" list="datalistbrandname" value="<?php echo $row2["brand_id"]?>">
                            ...
                            <td><input type="text" required name="price[]" class="form-control price" value="<?php echo $row2["price"]?>"></td>
                            <td><input type="text" required name="qty[]" class="form-control qty" value="<?php echo $row2["qty"]?>"></td>
                            <td><input type="text" required name="total[]" class="form-control total" value="<?php echo $row2["amount"]?>"></td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><input type="text" name="grand_total" id="grand_total" class="form-control" required value="<?php echo $totalamount?>"></td>
                            </tr>
                        </tfoot>
                    </table>
