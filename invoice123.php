                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="product_tbody" class="product_tbody">
                            <tr class="tablerow">
                                ...
                                <!-- brand -->
                                <td id='selectbrand'>
                                    <input type="text" required name="brand[]" id='brand' class="form-control itemcode"  placeholder="Brand">
                                </td>
