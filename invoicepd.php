...
<body>
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="product_tbody" class="product_tbody">
                            <tr class="tablerow">
                                <td>
                                    <input type="text" required name="pname[]" class="form-control itemcode" list="datalistitemname" placeholder="Product">
                                ...
                                <td><input type="button" value="+ Add Row" class="btn btn-primary btn-sm" id="btn-add-row"  onclick="addrow()"></td>
    ...
    <script>
        ...
        {
            alert("hello");
            // var test =$("#poduct_tbody").html();
            var test =$(".tablerow").html();
            console.log(test);
            alert(test);
                $('#htmltag').prepend(test);
